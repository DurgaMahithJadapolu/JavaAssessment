  ...
  function displayUserChoice() {
    ...
    switch (userChoice) {
      case 'rock':
        userSelectButton.querySelector('img').src = '/Code/icon-rock.png';
        userSelectButton.querySelector('img').alt = 'rock';
        userSelectButton.classList.add('btn-rock');
        break;
      case 'paper':
        userSelectButton.querySelector('img').src = '/Code/icon-paper.png';
        userSelectButton.querySelector('img').alt = 'paper';
        userSelectButton.classList.add('btn-paper');
        break;
      case 'scissors':
        userSelectButton.querySelector('img').src = '/Code/icon-Scissors.png';
  ...
  function displayComputerChoice() {
    ...
    switch (computerChoice) {
      case 'rock':
        computerSelectButton.querySelector('img').src = '/Code/icon-rock.png';
        ...
        break;
      case 'paper':
        computerSelectButton.querySelector('img').src = '/Code/icon-paper.png';
        ...
        break;
      case 'scissors':
        computerSelectButton.querySelector('img').src = '/Code/icon-Scissors.png';
